...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-primary" href="{{url('')}}/admin/create-schedule">
        <!-- {{url(env('POCEDU',''))}}/admin/createondemand -->
            Create Schedule
        </a>
    </div>
            ...
            <table class="  table table-bordered table-striped table-hover datatable datatable-Role">
                ...
                @foreach($datalist as $key => $schedule)
                        <tr data-entry-id="{{ $schedule->id }}">
                            ...
                            <td> <a href="{{url('')}}/admin/edit-scheduled-exam/{{$schedule->id}}"><i class="fas fa-pencil-alt"></i></a>
                             | <a href="{{url('')}}/admin/delete-scheduled-exam/{{$schedule->id}}" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
